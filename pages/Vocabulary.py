...
with tab1:
  ...
  url = "https://github.com/minn14/streamlit25/blob/main/data/word_frequency.csv"
  df = pd.read_csv(url)
...
with tab2:
  ...
  url = "https://github.com/minn14/streamlit25/blob/main/data/word_frequency.csv"  # ← replace this!
  df = pd.read_csv(url)
